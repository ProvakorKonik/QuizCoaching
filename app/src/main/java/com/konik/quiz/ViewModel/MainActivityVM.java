...
public class MainActivityVM  extends AndroidViewModel {
    public MainActivityVM(@NonNull Application application) {
        super(application);
        Log.d("ViewModel", "allViewModel:4 MainActivityVM start");
    }
                    ...
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {   //documnet er vitore je multiple document query ache er jonno for loop
                            ...
                            if(queryDocumentSnapshots.isEmpty()) {
                                // String quizUID, String quizName, String quizPhotoUrl, String quizSyllabus, String quizExtra, String quizCreator,
                                //                         int quiziTotalQues, int quiziPriority, int quiziTotalParticipant, int quiziDuration, Date quiziDate
                                listContestItem.add(new ContestsModel("UID","NULL", "PhotoUrl","Syllabus", "quizExtra","quizCreator" ,
                                        0, 0,0,0,null));
                                ...
                                for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                    ...
                                    listContestItem.add(new ContestsModel(dsContest_UID,dsContest_Name,dsContest_PhotoUrl,dsContest_Syllabus,dsContest_Extra,dsContest_Creator
                                            ,diContest_TotalQuestion,diContest_Priority,diContest_Participent,diContest_Duration,null));
                                    mLiveData.postValue(listContestItem);
                                }
